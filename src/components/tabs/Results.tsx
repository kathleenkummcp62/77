...
export function Results() {
  ...
  const resultFiles: ResultFile[] = [
    {
      id: '1',
      name: 'valid_fortinet_194.0.234.203.txt',
      type: 'valid',
    ...
    {
      id: '2',
      name: 'valid_globalprotect_77.90.185.26.txt',
      type: 'valid',
      server: '77.90.185.26',
    ...
    {
      id: '3',
      name: 'valid_sonicwall_185.93.89.206.txt',
      type: 'valid',
    ...
    {
      id: '4',
      name: 'errors_cisco_185.93.89.35.txt',
      type: 'errors',
      server: '185.93.89.35',
      vpnType: 'Cisco',
      size: '856 KB',
    ...
    {
      id: '5',
      name: 'logs_system_194.0.234.203.txt',
      type: 'logs',
      server: '194.0.234.203',
      vpnType: 'System',
      size: '4.2 MB',
