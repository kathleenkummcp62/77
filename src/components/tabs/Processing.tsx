...
export function Processing() {
  ...
  const handleTaskAction = (
    ...
    if (task) {
      switch (action) {
        case "start":
          if (task.vpn_type) startScanner(task.vpn_type.toLowerCase());
          break;
        case "pause":
          // Implement pause logic
          break;
        case "stop":
          if (task.vpn_type) stopScanner(task.vpn_type.toLowerCase());
          break;
      }
    }
  };
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Monitor and control active scanning tasks
          </p>
        </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-600">
                {tasks
                  .reduce((sum, t) => sum + t.processed, 0)
                  .toLocaleString()}
              </p>
            </div>
              ...
              >
                ...
                <div className="flex items-center justify-between text-sm text-gray-600 mb-4">
                  <div className="flex items-center space-x-1">
                    ...
                    <span>Started: {task.created_at}</span>
                  </div>
                </div>
